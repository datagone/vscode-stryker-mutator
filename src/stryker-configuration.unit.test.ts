...
// const defaultPathErrorMessage: string =
...
describe('WHEN Initializing the configuration file', () => {
  ...
  // // TODO: to potentially remove since we may use the workspaceFolder instead
  // describe('GIVEN the folderpath is not a valid one', () => {
  //   it('THEN it should rejects with the default path error message', async () => {
  //     // Arrange (GIVEN)
  //     const folderPath: Uri = Uri.file('./ASolutionFolder/NotValid');
  //     mockGetWorkspaceFolder.mockReturnValue({
  //       uri: {
  ...
  //     });
  //     // Act (WHEN)
  //     const result = configuration.initializeBasicConfiguration(folderPath);
  //     // Assert (THEN)
  //     await expect(result).rejects.toBe(defaultPathErrorMessage);
  //     expect(stubLogger.warning).toHaveBeenCalledTimes(1);
  //     expect(stubLogger.warning).toHaveBeenCalledWith(defaultPathErrorMessage);
  //   });
  // });

  // describe('GIVEN the folderpath is undefined', () => {
  //   it('THEN it should use the default workspace root path', async () => {
  //     // Arrange (GIVEN)
  //     const otherPath: Uri = Uri.file('./Other/Path');
  //     const workspaceRootPath: Uri = Uri.file('./Workspace/Root/Path');
  //     const expectMessageToBeLogged = `Creating the stryker configuration file into: ${workspaceRootPath.path}`;
  //     // mockGetWorkspaceFolder.mockReturnValue({/*should be undefined*/
  //     //   uri: {
  //     //     path: workspaceRootPath.path,
  //     //     fspath: workspaceRootPath.path,
  //     //   },
  //     // });

  //     const mockFolder: vscode.WorkspaceFolder = {
  //       uri: workspaceRootPath,
  //       name: 'workspace',
  //       index: 0,
  //     };
  //     // mockWorkspaceFolder.mockReturnValue({
  //     //   uri: {
  //     //     path: workspaceRootPath.path,
  //     //     fspath: workspaceRootPath.path,
  //     //   },
  ...
  //     //   index: 0
  //     // });
  //     // mockWorkspaceFolders.mockReturnValue([mockWorkspaceFolder]);
  //     const mockFolders: vscode.WorkspaceFolder[] = [mockFolder];
  //     // const mockWorkspaceFolders: vscode.WorkspaceFolder[] & {
  //     //   forEach: jest.MockedFunction<typeof Array.prototype.forEach>;
  //     //   map: jest.MockedFunction<typeof Array.prototype.map>;
  //     //   reduce: jest.MockedFunction<typeof Array.prototype.reduce>;
  //     //   some: jest.MockedFunction<typeof Array.prototype.some>;
  //     //   find: jest.MockedFunction<typeof Array.prototype.find>;
  //     //   //[Symbol.iterator]: jest.MockedFunction<typeof Array.prototype[Symbol.iterator]>;
  //     // } = Object.assign(mockFolders, {
  //     //   forEach: jest.fn(),
  //     //   map: jest.fn(),
  //     //   reduce: jest.fn(),
  //     //   some: jest.fn(),
  ...
  //       })
  //     };
  //     jest.spyOn(workspace, 'workspaceFolders'/*, 'get'*/).mockReturnValue(mockWorkspaceFolders);
  //     // const fakeWorkspaceFolder: WorkspaceFolder = {
  //     //   uri: workspaceRootPath,//Uri.parse('file:///fake/workspace/folder'),
  //     //   name: 'Fake Workspace Folder',
  //     //   index: 0,
  //     // };
  //     // const workspaceFoldersSpy = jest.spyOn(mockWorkspace, 'workspaceFolders', 'get');
  //     // workspaceFoldersSpy.mockReturnValue([fakeWorkspaceFolder]);

  //     // const tempUri: Uri = Uri.file(workspaceRootPath.path);
  //     // const workspaceFolder: vscode.WorkspaceFolder = { uri: tempUri,  index: 0,  name: 'WorkspaceFolder' };
  //     // mockWorkspaceFolders.mockReturnValue([workspaceFolder]);

  //     // Act (WHEN)
  //     const result = configuration.initializeBasicConfiguration(otherPath);
  //     // Assert (THEN)
  //     await expect(result).resolves.toContain(workspaceRootPath.path);
  //   });
  // });
...
describe('WHEN Creating the configuration file', () => {
  // // TODO: to potentially remove since we may use the workspaceFolder instead
  // describe('GIVEN an empty folderpath', () => {
  //   it('THEN it should rejects with the default path error message', async () => {
  //     // Arrange (GIVEN)
  //     const emptyFolderPath: Uri = Uri.file('');

  //     // Act (WHEN)
  //     const result = configuration.createStrykerConfigurationFile(emptyFolderPath);
  //     // Assert (THEN)
  //     await expect(result).rejects.toBe(defaultPathErrorMessage);
  //     expect(stubLogger.warning).toHaveBeenCalledTimes(1);
  //     expect(stubLogger.warning).toHaveBeenCalledWith(defaultPathErrorMessage);
  ...
  // // TODO: to potentially remove since we may use the workspaceFolder instead
  // describe('GIVEN a folderpath not ending with .Tests nor .Test', () => {
  //   it('THEN it should rejects with the default path error message', async () => {
  //     // Arrange (GIVEN)
  //     const emptyFolderPath: Uri = Uri.file('./a-folder.SomeOtherThing');
