...
export type DotnetType = {
  ...
  // mutateAFile(filename: string, args: string[]): Promise<void>;
  // mutateAllFilesInFolder(folder: string, args: string[]): Promise<void>;
  // mutateAllFiles(args: string[]): Promise<void>;
};
...
export class Dotnet implements DotnetType {
  ...
  // TODO : Uncomment these when ready to run the stryker command on a project/file/selection
  // public async mutateAFile(filename: string, args: string[]): Promise<void> {
  //   // TODO: IMPLEMENT THIS THING
  //   console.log(`cmd: mutateAFile => filename: "${filename}", args: "${args.join(' ')}"`);
  //   return Promise.resolve();
  // }

  // public async mutateAllFilesInFolder(folderpath: string, args: string[]): Promise<void> {
  //   // TODO: IMPLEMENT THIS THING
  //   console.log(`cmd: mutateAllFilesInFolder => folderpath: "${folderpath}", args: "${args.join(' ')}"`);
  //   return Promise.resolve();
  // }

  // public async mutateAllFiles(args: string[]): Promise<void> {
  //   // TODO: IMPLEMENT THIS THING
  //   console.log(`cmd: mutateAllFiles => args: "${args.join(' ')}"`);
  //   return Promise.resolve();
  // }
